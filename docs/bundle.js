...
function changeToSee() {
	$('#landing').addClass('bg-2-red').on('animationend', function () {
...
function changeToMove() {
	$('#landing').addClass('bg-2-black').on('animationend', function () {
...
function changeToHear() {
	$('#landing').addClass('bg-2-yellow').on('animationend', function () {
